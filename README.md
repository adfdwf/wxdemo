...
```powershell
cmake -S . -B build-vs -G "Visual Studio 17 2022" -A x64 -DCMAKE_PREFIX_PATH="D:/Softwares/QT/6.10.2/msvc2022_64"
cmake --build build-vs --config Release
.\build-vs\Release\wxdemo.exe
```

如果已经在 Visual Studio 中配置了 Qt/CMake 环境，也可以直接用 VS 打开本文件夹。
