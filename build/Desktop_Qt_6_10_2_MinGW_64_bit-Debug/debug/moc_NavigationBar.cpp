...
#include "../../../src/widgets/NavigationBar.h"
...
template <> constexpr inline auto NavigationBar::qt_create_metaobjectdata<qt_meta_tag_ZN13NavigationBarE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(NavigationPage)>(3, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 4, 5 },
        }}),
...
void NavigationBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->pageRequested((*reinterpret_cast<std::add_pointer_t<NavigationPage>>(_a[1]))); break;
        case 2: _t->settingsRequested(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (NavigationBar::*)()>(_a, &NavigationBar::profileRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (NavigationBar::*)(NavigationPage )>(_a, &NavigationBar::pageRequested, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (NavigationBar::*)()>(_a, &NavigationBar::settingsRequested, 2))
            return;
    }
}
...
// SIGNAL 0
void NavigationBar::profileRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void NavigationBar::pageRequested(NavigationPage _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void NavigationBar::settingsRequested()
{
